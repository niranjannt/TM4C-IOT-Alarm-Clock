...
//	strcpy(first_token, strtok(w2b_buf, ","));
   uint8_t cmd_num=atoi(w2b_buf);	
	 switch(cmd_num){
	 	case 0:     digital=0; erase=1; break;
		case 1:     digital=1; erase=1; break;
		case 2:     digital=2; erase=1; break;	
		case 3:     hours = ((hours % 12) + 1); break; // Increment Hours
		case 4:     minutes = ((minutes +1) % 60); break;         //Increment Minutes
		case 5:     seconds=((seconds + 1)%60); break;         //Increment Seconds
		case 6:     hours = ((hours - 2 + 12) % 12) + 1; break; // Increment Hours
		case 7:     minutes = ((minutes - 1 + 60) % 60); break;         //Increment Minutes
		case 8:     seconds=((seconds-1+60)%60); break;         //Increment Seconds
		case 9:     alarmhours = (alarmhours % 12) + 1; break;                //Increment Alarm Hours
		case 10:    alarmminutes=(alarmminutes+1)%60; break;                 //Increment Alarm Minutes
		case 11:    alarmseconds = (alarmseconds+1)%60; break;                     //Increment Alarm Seconds
		case 12:    alarmsetdone=1; break;                     //Alarm Time is Set
		case 13:    timesetdone=1; break;                //Initial Time is Set
		case 14:     isPM=!isPM; break;         //isPM
		case 15:     colorindex=(colorindex+1)%6; break; 
		case 16:     alarmhours=(alarmhours - 2 + 12) % 12 + 1; break;                //Increment Alarm Hours
		case 17:    alarmminutes=(alarmminutes - 1 + 60) % 60; break;                 //Increment Alarm Minutes
		case 18:    alarmseconds=(alarmseconds-1+60)%60; break;                     //Increment Alarm Seconds
		 //colorindex
